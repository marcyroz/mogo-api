...
class RotaSerializer(serializers.ModelSerializer):
    ...
    erro_mensagem = serializers.CharField(read_only=True, allow_null=True)
    ...
    class Meta:
        ...
        read_only_fields = ['polyline_line', 'score_acessibilidade', 'created_at', 'status_processamento', 'erro_mensagem']
